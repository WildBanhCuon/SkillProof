  ...
  return (
    <div>
      <p className="text-sm text-slate-500 dark:text-slate-400 dark:text-slate-500">
        ...
        {' · '}
        <Link to="/hr/candidates" className="hover:text-indigo-600 dark:text-indigo-400">
          All candidates
        </Link>{' '}
        / Results
      </p>
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <Card key={s.label} className="p-4">
              <p className="text-xs font-medium uppercase text-slate-500 dark:text-slate-400 dark:text-slate-500">
                {s.label}
              </p>
      ...
      <div className="mt-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          <div className="relative">
            ...
            <input
              className="rounded-lg border border-slate-200 dark:border-slate-700 py-2 pl-9 pr-3 text-sm"
      ...
      {isLoading && <p className="mt-8 text-slate-500 dark:text-slate-400 dark:text-slate-500">Loading candidates…</p>}
