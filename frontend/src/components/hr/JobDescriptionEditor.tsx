...
export function JobDescriptionEditor({
  ...
  const editor = useEditor({
    ...
    editorProps: {
      attributes: {
        class:
          'prose-editor min-h-[280px] px-4 py-3 text-sm leading-relaxed text-slate-700 focus:outline-none',
      },
    },
  });
  ...
  return (
    <div className="job-description-editor mt-3 overflow-hidden rounded-lg border border-slate-200">
      {editable && (
